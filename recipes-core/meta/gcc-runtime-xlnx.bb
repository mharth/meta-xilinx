...
FILES_libssp-dev = "\
	...
	${libdir}/libssp*.la \
	${libdir}/gcc/${CSL_TARGET_SYS}/${CSL_VER_GCC}/include/ssp \
"
...
do_install() {
	...
	install -d ${D}/${libdir} \
		${D}/${includedir} \
		${D}/${libdir}/gcc/${CSL_TARGET_SYS}/${CSL_VER_GCC}/include/ssp

	find $root \( -path "*/${CSL_TARGET_SYS}/*/libstdc++.*" \
		-o -path "*/${CSL_TARGET_SYS}/*/libatomic.*" \
		-o -path "*/${CSL_TARGET_SYS}/*/libssp*" \
		-o -path "*/${CSL_TARGET_SYS}/*/libsupc++.a" \) \
		-exec cp -a {} ${D}/usr/lib \;

	cp -a ${sysroot}/../include/. ${D}/${includedir}

	find $root -path "*/${CSL_TARGET_SYS}/*/include/ssp/*" \
	-exec cp -a {} ${D}/usr/lib/gcc/${CSL_TARGET_SYS}/${CSL_VER_GCC}/include/ssp \;
